class Tarea{
    constructor(id,texto,estado,contenedor){
        ...
        this.texto = texto;
        this.DOM = null;
        this.editando = false; //Esta propiedad determina el estado de la tarea, si estamos editándola o no
    ...
    crearDOM(contenedor, estado){
        ...
        botonEstado.appendChild(document.createElement("span"));//tambien es posible hacer con botonEstado.innerHTML = "<span></span>";
    ...
    async editarTexto(){
        if(this.editando){
            ...
            //desactivar interfaz de edición
            ...
            //console.log("activar la interfaz de edicion")
